              ...
              <div className="relative z-10">
                <div className="grid grid-cols-2 gap-6 mb-4">
                  <div className="text-center">
                    ...
                    <p className="text-3xl md:text-4xl font-bold">€2,000–€2,300</p>
                  </div>
                  <div className="text-center">
                    <p className="text-sm text-blue-100/90 mb-2">Senior Level</p>
                    <p className="text-3xl md:text-4xl font-bold">€3,200–€3,600</p>
                  </div>
                </div>
                <p className="text-xl text-blue-100 mb-1 text-center">Gross per month</p>
                <p className="text-sm text-blue-100/90 text-center">Part-time · Weekdays 15:30-20:00 · Fixed hours</p>
              </div>
            </div>
