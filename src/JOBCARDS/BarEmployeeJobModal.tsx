              ...
              <div className="relative z-10">
                <div className="grid grid-cols-2 gap-6 mb-4">
                  <div className="text-center">
                    <p className="text-sm text-indigo-100/90 mb-2">Entry Level</p>
                    <p className="text-3xl md:text-4xl font-bold">€2,100–€2,300</p>
                  </div>
                  <div className="text-center">
                    <p className="text-sm text-indigo-100/90 mb-2">Senior Level</p>
                    <p className="text-3xl md:text-4xl font-bold">€3,000–€3,200</p>
                  </div>
                </div>
