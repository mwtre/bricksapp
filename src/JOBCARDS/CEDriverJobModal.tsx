          ...
          <div className="p-8 space-y-8">
            ...
            <div className="relative bg-gradient-to-r from-green-500 to-green-600 rounded-2xl p-8 text-white shadow-xl overflow-hidden">
              ...
              <div className="relative z-10">
                <p className="text-4xl md:text-5xl font-bold mb-2">€4,212–€4,216</p>
                <p className="text-xl text-green-100 mb-1">Gross per month</p>
                <p className="text-sm text-green-100/90">50 hours/week · CE License · Accommodation arranged</p>
              </div>
            </div>
