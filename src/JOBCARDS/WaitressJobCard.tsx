                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-baseline gap-2">
                    ...
                    <div className="flex flex-col">
                      <span className="text-xs text-gray-500">Entry: €2,000–€2,200</span>
                      <span className="text-sm text-gray-600">Mid: €2,500–€2,600</span>
                      <span className="text-xs text-gray-500">Senior: €2,800–€3,000</span>
                    </div>
                  </div>
