          ...
          <div className="p-8 space-y-8">
            ...
            <div className="relative bg-gradient-to-r from-teal-500 to-teal-600 rounded-2xl p-8 text-white shadow-xl overflow-hidden">
              ...
              <div className="relative z-10">
                <p className="text-4xl md:text-5xl font-bold mb-2">€2,700–€3,200</p>
                <p className="text-xl text-teal-100 mb-1">Gross per month</p>
                <p className="text-sm text-teal-100/90">1–40 hours/week · Permanent · Lower School</p>
              </div>
            </div>
