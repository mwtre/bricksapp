...
import { Wrench, Euro, ChevronRight } from 'lucide-react';
import BikeMechanicJobModal from './BikeMechanicJobModal';

export default function BikeMechanicJobCard() {
  ...
  return (
    <>
      ...
      >
        <div className="flex items-stretch h-full min-h-[280px]">
          <div className="w-48 flex-shrink-0 overflow-hidden bg-gradient-to-br from-blue-50 to-blue-100">
            <img
              src={`${import.meta.env.BASE_URL}jobcards/mecacard.png`}
              alt="Bike Mechanic"
          ...
          <div className="flex-1 p-6 flex flex-col min-w-0">
            ...
            <p className="text-sm text-gray-600 leading-relaxed mb-6 flex-1">
              Repair bikes and be part of Swapfiets's mission to make biking the easy, sustainable choice for everyone.
            </p>
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-baseline gap-2">
                    ...
                    <div className="flex flex-col">
                      ...
                      <span className="text-sm text-gray-600">Mid: €2,500–€3,000</span>
                      <span className="text-xs text-gray-500">Senior: €3,200–€3,600</span>
                    </div>
                  </div>
      ...
      {isOpen && <BikeMechanicJobModal onClose={() => setIsOpen(false)} />}
    </>
  );
}
