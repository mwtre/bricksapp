          ...
          <div className="p-8 space-y-8">
            ...
            <div className="relative bg-gradient-to-r from-red-500 to-red-600 rounded-2xl p-8 text-white shadow-xl overflow-hidden">
              ...
              <div className="relative z-10">
                <p className="text-4xl md:text-5xl font-bold mb-2">€2,800–€3,600</p>
                <p className="text-xl text-red-100 mb-1">Gross per month</p>
                <p className="text-sm text-red-100/90">35–42 hours/week · Long-term contract · Food Production</p>
              </div>
            </div>
