              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  <div className="flex items-baseline gap-2">
                    <Euro className="w-5 h-5 text-indigo-600 flex-shrink-0" />
                    <div className="flex flex-col">
                      <span className="text-xs text-gray-500">Entry: €2,100–€2,300</span>
                      <span className="text-sm text-gray-600">Mid: €2,550–€2,700</span>
                      <span className="text-xs text-gray-500">Senior: €3,000–€3,200</span>
                    </div>
                  </div>
