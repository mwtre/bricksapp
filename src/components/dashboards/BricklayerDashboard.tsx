...
import { Calendar, Clock, MapPin, Users, TrendingUp, AlertTriangle } from 'lucide-react';
...
export const BricklayerDashboard: React.FC = () => {
  ...
  const myProjects = mockProjects.filter((p: Project) => p.assignedBricklayers?.includes(user?.id || ''));
